...
**Entry point**: [fastapi_server.py](https://github.com/icos-project/topology-exporter/tree/main/src/fastapi_server.py)

## Docker Compose

**Requirement**: [Docker Engine](https://docs.docker.com/engine/install/) and [Docker Compose](https://docs.docker.com/compose/install/)

**Example**: [compose.yaml](https://github.com/icos-project/topology-exporter/tree/main/tests/compose.yaml)

## Helm Chart

**Requirement**: [Helm](https://helm.sh/docs/intro/install/)

**Files**: [chart](https://github.com/icos-project/topology-exporter/tree/main/chart/)